...
pytype_path = pyinder_run_path + '/pytype'
...
def run(skip, project, num) :
    check_directory_and_make_directory(pytype_path)
    for target_project in target_projects :
        ...
        config_path = pyinder_run_path + '/config/' + target_project + '/pytype.cfg'
        result_path = pytype_path + '/' + target_project
