...
pyright_path = pyinder_run_path + '/pyright_annotated'
...
def run(skip, project, num) :
    ...
    for target_project in target_projects :
        ...
        benchmark_path = '/home/wonseok/benchmark_annotated/' + target_project
...
def bugsinpy(skip, project, num) :
    ...
    for target_project in bugsinpy_projects :
        ...
        result_file = result_path + '/result.json'
        check_directory_and_make_directory(result_path)
        benchmark_path = '/home/wonseok/BugsInPy/benchmark_annotated/' + target_project
...
def main(argv) :
    ...
    bugsinpy(args.skip, args.project, args.num)
